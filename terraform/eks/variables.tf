...
variable "public_subnets" {
    type    = "list"
    description = "replace these values as per your choice of subnet range"
...
variable "eks_version" {
   description = "kubernetes cluster version provided by AWS EKS - e.g. 1.12"
}
